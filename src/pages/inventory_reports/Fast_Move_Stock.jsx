...
import { useCurrentStock, useDeadtStock, useFastMoveStock } from "@/hooks/useStock";
import { getFastMoveStockColumns } from "./components/fastMoveStockColumn";

export default function FastMoveStockReport() {
  ...
  const { data: stockData = {}, isLoading } = useFastMoveStock({
      store_id: 1,
  ...
  const columns = getFastMoveStockColumns();
