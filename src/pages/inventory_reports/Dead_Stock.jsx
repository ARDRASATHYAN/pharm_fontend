...
import { useCurrentStock, useDeadtStock } from "@/hooks/useStock";
import { getDeadStockColumns } from "./components/deadStockColumns";
...
export default function DeadStockReport() {
  ...
  const { data: stockData = {}, isLoading } = useDeadtStock({
      store_id: 1,
  ...
  const columns = getDeadStockColumns();
