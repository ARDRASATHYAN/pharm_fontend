...
import { useCurrentStock, useOutOfftStock } from "@/hooks/useStock";
import { getOutOffStockColumns } from "./components/outoffStockColumn";

export default function OutOffStockReport() {
  ...
  const { data: stockData = {}, isLoading } = useOutOfftStock({
      store_id: 1,
  ...
  const columns = getOutOffStockColumns();
